...
qpath=/opt/hex_users/$USER/chenghao/udao-spark-optimizer/udao_trace_examples/assets/job/spark-sqls

~/spark/bin/spark-submit \
--class edu.polytechnique.cedar.spark.benchmark.RunJOBTemplateQueryForRuntime \
--name ${name} \
--master yarn \
--deploy-mode client \
