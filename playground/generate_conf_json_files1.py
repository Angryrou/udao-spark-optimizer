...
if __name__ == "__main__":
    ...
    # # for TPCDS
    save_data_header_tpcds_query_info = "./output/0218test/tpcds_traces"
    query_id_path = f"{save_data_header_tpcds_query_info}/query_info/query_id_list.txt"
    n_stages_path = f"{save_data_header_tpcds_query_info}/query_info/n_stages_list.txt"
    ...
    save_data_header_tpch = f"./output/0218test/tpch_traces/test_end_diff_p"
    save_json_header_tpch = f"./output/0218test/tpch_traces/test_end_diff_p/{model_name2}/oracle_{is_oracle}/{weights[0]}_{weights[1]}/configurations_json"
    methods = ["div_and_conq_moo%B"]
    generate_json_file(
                       methods=methods,
