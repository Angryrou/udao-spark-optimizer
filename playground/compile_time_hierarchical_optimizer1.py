...
from udao_spark.optimizer.hierarchical_optimizer1 import HierarchicalOptimizer1
...
if __name__ == "__main__":
    ...
    hier_optimizer = HierarchicalOptimizer1(
        bm=bm,
    ...
    # test with <= 10 subQs
    raw_traces_test = [raw_traces[0], raw_traces[2], raw_traces[3], raw_traces[5], raw_traces[9],
                       raw_traces[10], raw_traces[11], raw_traces[12], raw_traces[13], raw_traces[14],
                       raw_traces[15], raw_traces[16], raw_traces[17], raw_traces[18], raw_traces[21]]
    for trace in raw_traces:
